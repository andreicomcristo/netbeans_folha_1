...
@NamedQueries({
    ...
    @NamedQuery(name = "FuncionariosCapacitacoes.findByDescricaoHabilitacaoCategoria", query = "SELECT f FROM FuncionariosCapacitacoes f WHERE f.descricaoHabilitacaoCategoria = :descricaoHabilitacaoCategoria"),
    @NamedQuery(name = "FuncionariosCapacitacoes.findByNomeHabilitacaoCategoria", query = "SELECT f FROM FuncionariosCapacitacoes f WHERE f.nomeHabilitacaoCategoria = :nomeHabilitacaoCategoria")})
public class FuncionariosCapacitacoes implements Serializable {
    ...
    public FuncionariosCapacitacoes(Long id, String descricao, String nomeHabilitacaoCategoria) {
        this.id = id;
    ...
    public String toString() {
        return "br.com.folha.model.tabelas4.FuncionariosCapacitacoes[ id=" + id + " ]";
    }
