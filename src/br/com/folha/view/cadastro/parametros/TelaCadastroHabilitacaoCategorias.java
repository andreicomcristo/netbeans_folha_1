 ...
 * @author André
 */
public class TelaCadastroHabilitacaoCategorias extends javax.swing.JFrame {

    
    ControleCadastroHabilitacaoCategorias controleCadastroHabilitacao;
    BeanCadastroHabilitacaoCategorias beanCadastroHabilitacao;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroHabilitacaoCategorias() {
    ...
    public TelaCadastroHabilitacaoCategorias(ControleCadastroHabilitacaoCategorias controleCadastroHabilitacao, BeanCadastroHabilitacaoCategorias beanCadastroHabilitacao) {
        this.controleCadastroHabilitacao = controleCadastroHabilitacao;  
        this.beanCadastroHabilitacao = beanCadastroHabilitacao;
        ...
        preencherJtable1d(controleCadastroHabilitacao.selecionar());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Habilitação");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(170, 20, 390, 20);

        jLabel2.setFont(new java.awt.Font("Bookman Old Style", 1, 11)); // NOI18N
        jLabel2.setText("Descrição da Habilitação");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(300, 60, 160, 20);
        ...
        jTextField1.setBounds(110, 60, 150, 25);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SEQ","HABILITAÇÃO","DESCRIÇÃO DA HABILITAÇÃO"
            }
        ));
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroHabilitacao.cadastrar(jTextField1.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqHabilitacao  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroHabilitacao.excluir(seqHabilitacao);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqHabilitacao  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();              
            String nomeHabilitacao = jTextField1.getText();
            String descricaoHabilitacao = jTextField2.getText();
            controleCadastroHabilitacao.alterar(seqHabilitacao, nomeHabilitacao, descricaoHabilitacao);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroHabilitacaoCategorias().setVisible(true);
            }
        });
    }
    ...
    public void preencherJtable1d(List<BeanCadastroHabilitacaoCategorias> dados  ){
        ...
        for ( BeanCadastroHabilitacaoCategorias habilitacao : dados) {

            Object[] linha = new Object[] { habilitacao.getSeqHabilitacaoCategoria(), habilitacao.getNomeHabilitacaoCategoria(), habilitacao.getDescricaoHabilitacaoCategoria()};
            modelo.addRow(linha);
        }
 }
