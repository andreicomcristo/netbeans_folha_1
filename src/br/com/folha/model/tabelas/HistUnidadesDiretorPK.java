...
public class HistUnidadesDiretorPK implements Serializable {
    ...
    public String toString() {
        return "br.com.folha.model.tabelas.HistUnidadesDiretorPK[ id=" + id + ", idUnidadeDeSaudeFk=" + idUnidadeDeSaudeFk + ", idPessoaFk=" + idPessoaFk + ", idOperadorCadastroFk=" + idOperadorCadastroFk + ", dtCadastro=" + dtCadastro + " ]";
    }
