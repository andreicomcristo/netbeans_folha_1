...
@NamedQueries({
    ...
    @NamedQuery(name = "Cids.findById", query = "SELECT c FROM Cids c WHERE c.id = :id"),
    @NamedQuery(name = "Cids.findByCodCid", query = "SELECT c FROM Cids c WHERE c.codCid = :codCid"),
    @NamedQuery(name = "Cids.findByDescricaoCid", query = "SELECT c FROM Cids c WHERE c.descricaoCid = :descricaoCid")})
public class Cids implements Serializable {
    ...
    public String toString() {
        return "br.com.folha.model.tabelas4.Cids[ id=" + id + " ]";
    }
