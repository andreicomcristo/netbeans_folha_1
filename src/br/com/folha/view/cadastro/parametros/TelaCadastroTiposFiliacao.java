...
public class TelaCadastroTiposFiliacao extends javax.swing.JFrame {

    
    ControleCadastroTiposFiliacao controleCadastroTiposFiliacao;
    BeanCadastroTiposFiliacao beanCadastroFiliacao;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroTiposFiliacao() {
    ...
    public TelaCadastroTiposFiliacao(ControleCadastroTiposFiliacao controleCadastroFiliacao, BeanCadastroTiposFiliacao beanCadastroFiliacao) {
        this.controleCadastroTiposFiliacao = controleCadastroFiliacao;  
        this.beanCadastroFiliacao = beanCadastroFiliacao;
        ...
        preencherJtable1d(controleCadastroTiposFiliacao.selecionar());
    }
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroTiposFiliacao.cadastrar(jTextField1.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqFiliacao  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroTiposFiliacao.excluir(seqFiliacao);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqFiliacao  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();              
            String nomeFiliacao = jTextField1.getText();
            String descricaoFiliacao = jTextField2.getText();
            controleCadastroTiposFiliacao.alterar(seqFiliacao, nomeFiliacao, descricaoFiliacao);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroTiposFiliacao().setVisible(true);
            }
        });
    }
    ...
    public void preencherJtable1d(List<BeanCadastroTiposFiliacao> dados  ){
        ...
        for ( BeanCadastroTiposFiliacao filiacao : dados) {

            Object[] linha = new Object[] { filiacao.getSeqTipoFiliacao(), filiacao.getNomeTipoFiliacao(), filiacao.getDescricaoTipoFiliacao()};
            modelo.addRow(linha);
        }
 }
