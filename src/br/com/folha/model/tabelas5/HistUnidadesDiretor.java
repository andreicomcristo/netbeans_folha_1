...
@NamedQueries({
    ...
    @NamedQuery(name = "HistUnidadesDiretor.findById", query = "SELECT h FROM HistUnidadesDiretor h WHERE h.id = :id"),
    @NamedQuery(name = "HistUnidadesDiretor.findByDtCadastro", query = "SELECT h FROM HistUnidadesDiretor h WHERE h.dtCadastro = :dtCadastro"),
...
public class HistUnidadesDiretor implements Serializable {
    ...
    public HistUnidadesDiretor(Long id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "br.com.folha.model.tabelas5.HistUnidadesDiretor[ id=" + id + " ]";
    }
