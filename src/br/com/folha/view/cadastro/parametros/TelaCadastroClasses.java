 ...
 * @author André
 */
public class TelaCadastroClasses extends javax.swing.JFrame {

    
    ControleCadastroClasses controleCadastroClasses;
    BeanCadastroClasses beanCadastroClasses;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroClasses() {
    ...
    public TelaCadastroClasses(ControleCadastroClasses controleCadastroClases, BeanCadastroClasses beanCadastroClasses) {
        this.controleCadastroClasses = controleCadastroClases;  
        this.beanCadastroClasses = beanCadastroClasses;
        ...
        preencherJtable1d(controleCadastroClases.selecionar());
    }
    ...
    private void initComponents() {
        ...
        jTextField3.addKeyListener(new KeyAdapter() {   
            public void keyTyped(KeyEvent e) { // <- alteração   
                ...
                if(jTextField3.getText().length()>=300){e.setKeyChar('\0');}
        ...
        jTextField3.setBounds(120, 90, 590, 25);
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroClasses.cadastrar(jTextField1.getText().toUpperCase(), jTextField3.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqClasse  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroClasses.excluir(seqClasse);
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        preencherJtable1d(controleCadastroClasses.selecionar());
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqClasse  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();              
            String siglaClasse = jTextField1.getText();
            String nomeClasse = jTextField2.getText();
            String descricaoClasse = jTextField3.getText();
            controleCadastroClasses.alterar(seqClasse, siglaClasse, nomeClasse, descricaoClasse);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    ...
    public void preencherJtable1d(List<BeanCadastroClasses> dados  ){
        ...
        for ( BeanCadastroClasses beanCadastroClasses : dados) {

            Object[] linha = new Object[] { beanCadastroClasses.getSeqClasses(), beanCadastroClasses.getSiglaClasse(), beanCadastroClasses.getNomeClasse(), beanCadastroClasses.getDescricaoClasse()};
            modelo.addRow(linha);
        }
 }
