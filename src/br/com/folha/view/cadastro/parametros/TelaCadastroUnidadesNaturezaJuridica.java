...
public class TelaCadastroUnidadesNaturezaJuridica extends javax.swing.JFrame {

    
    ControleCadastroUnidadesNaturezaJuridica controleCadastroUnidadesNaturezaJuridica;
    BeanCadastroUnidadesNaturezaJuridica beanCadastroNaturezaJuridica;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroUnidadesNaturezaJuridica() {
    ...
    public TelaCadastroUnidadesNaturezaJuridica(ControleCadastroUnidadesNaturezaJuridica controleCadastroNaturezaJuridica, BeanCadastroUnidadesNaturezaJuridica beanCadastroNaturezaJuridixa) {
        this.controleCadastroUnidadesNaturezaJuridica = controleCadastroNaturezaJuridica;  
        this.beanCadastroNaturezaJuridica = beanCadastroNaturezaJuridixa;
        ...
        preencherJtable1d(controleCadastroUnidadesNaturezaJuridica.selecionar());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Unidades de Natureza Jurídica");
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Bookman Old Style", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Cadastro de Unidades de natureza jurídica");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(170, 20, 390, 20);

        jLabel2.setFont(new java.awt.Font("Bookman Old Style", 1, 11)); // NOI18N
        jLabel2.setText("Descrição da Natureza Jurídica");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(300, 60, 200, 20);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SEQ","UNIDADE NATUREZA JURÍDICA","DESCRIÇÃO NATUREZA JURÍDICA"
            }
        ));
        ...
        jTextField2.setBounds(500, 60, 210, 25);

        jLabel3.setFont(new java.awt.Font("Bookman Old Style", 1, 11)); // NOI18N
        jLabel3.setText("Natureza Jurídica");
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroUnidadesNaturezaJuridica.cadastrar(jTextField1.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqNaturezaJuridica  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroUnidadesNaturezaJuridica.excluir(seqNaturezaJuridica);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqNaturezaJuridica  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();              
            String nomeNaturezaJuridica = jTextField1.getText();
            String descricaoNaturezaJuridica = jTextField2.getText();
            controleCadastroUnidadesNaturezaJuridica.alterar(seqNaturezaJuridica, nomeNaturezaJuridica, descricaoNaturezaJuridica);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroUnidadesNaturezaJuridica().setVisible(true);
            }
        });
    }
    ...
    public void preencherJtable1d(List<BeanCadastroUnidadesNaturezaJuridica> dados  ){
        ...
        for ( BeanCadastroUnidadesNaturezaJuridica naturezaJuridica : dados) {

            Object[] linha = new Object[] { naturezaJuridica.getSeqUnidadeNaturezaJurudica(), naturezaJuridica.getNomeNaturazaJuridica(), naturezaJuridica.getDescricaoNaturezaJuridica()};
            modelo.addRow(linha);
        }
 }
