...
public class TelaCadastroTiposLogradouro extends javax.swing.JFrame {

    
    ControleCadastroTiposLogradouro controleCadastroTiposLogradouro;
    BeanCadastroTiposLogradouro beanCadastroLogradouro;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroTiposLogradouro() {
    ...
    public TelaCadastroTiposLogradouro(ControleCadastroTiposLogradouro controleCadastroLogradouro, BeanCadastroTiposLogradouro beanCadastroLogradouro) {
        this.controleCadastroTiposLogradouro = controleCadastroLogradouro;  
        this.beanCadastroLogradouro = beanCadastroLogradouro;
        ...
        preencherJtable1d(controleCadastroTiposLogradouro.selecionar());
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(100, 60, 150, 25);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SEQ","LOGRADOURO","DESCRIÇÃO DO LOGRADOURO"
            }
        ));
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroTiposLogradouro.cadastrar(jTextField1.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqLogradouro  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroTiposLogradouro.excluir(seqLogradouro);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqLogradouro  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();              
            String nomeLogradouro = jTextField1.getText();
            String descricaoLogradouro = jTextField2.getText();
            controleCadastroTiposLogradouro.alterar(seqLogradouro, nomeLogradouro, descricaoLogradouro);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroTiposLogradouro().setVisible(true);
            }
        });
    }
    ...
    public void preencherJtable1d(List<BeanCadastroTiposLogradouro> dados  ){
        ...
        for ( BeanCadastroTiposLogradouro logradouro : dados) {

            Object[] linha = new Object[] { logradouro.getSeqTipoLogradouro(), logradouro.getNomeTipoLogradouro(), logradouro.getDescricaoTipoLogradouro()};
            modelo.addRow(linha);
        }
 }
