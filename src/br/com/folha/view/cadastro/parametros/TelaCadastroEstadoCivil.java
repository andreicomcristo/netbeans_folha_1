 ...
 * @author André
 */
public class TelaCadastroEstadoCivil extends javax.swing.JFrame {

    
    ControleCadastroEstadoCivil controleCadastroEstadoCivil;
    BeanCadastroEstadoCivel beanCadastroEstadoCivil;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroEstadoCivil() {
    ...
    public TelaCadastroEstadoCivil(ControleCadastroEstadoCivil controleCadastroEstadoCIvil, BeanCadastroEstadoCivel beanCadastroEstadoCivil) {
        this.controleCadastroEstadoCivil = controleCadastroEstadoCIvil;  
        this.beanCadastroEstadoCivil = beanCadastroEstadoCivil;
        ...
        preencherJtable1d(controleCadastroEstadoCivil.selecionar());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Estado Civil");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(170, 20, 390, 20);

        jLabel2.setFont(new java.awt.Font("Bookman Old Style", 1, 11)); // NOI18N
        jLabel2.setText("Descrição do Estado Civil");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(280, 60, 170, 14);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SEQ","ESTADO CIVIL","DESCRIÇÃO DO ESTADO CIVIL"
            }
        ));
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroEstadoCivil.cadastrar(jTextField1.getText().toUpperCase(), jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            ...
            controleCadastroEstadoCivil.excluir(seq_carga_horaria_sem);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            ...
            controleCadastroEstadoCivil.alterar(seqVinculo, nomeVinculo, descricaoVinculo);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroEstadoCivil().setVisible(true);
            }
        });
    }
    ...
    public void preencherJtable1d(List<BeanCadastroEstadoCivel> dados  ){
        ...
        for ( BeanCadastroEstadoCivel estadoCivil : dados) {

            Object[] linha = new Object[] { estadoCivil.getSeqEstadoCivil(), estadoCivil.getNomeEstadoCivil(), estadoCivil.getDescricaoEstadoCivil()};
            modelo.addRow(linha);
