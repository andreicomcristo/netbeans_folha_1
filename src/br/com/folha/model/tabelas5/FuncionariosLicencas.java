...
@NamedQueries({
    ...
    @NamedQuery(name = "FuncionariosLicencas.findById", query = "SELECT f FROM FuncionariosLicencas f WHERE f.id = :id"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtInicial", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtInicial = :dtInicial"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtFinal", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtFinal = :dtFinal"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtCadastro", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtCadastro = :dtCadastro"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtUltimaAlteracao", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtUltimaAlteracao = :dtUltimaAlteracao"),
    @NamedQuery(name = "FuncionariosLicencas.findByCorteFolhaExtra", query = "SELECT f FROM FuncionariosLicencas f WHERE f.corteFolhaExtra = :corteFolhaExtra"),
    @NamedQuery(name = "FuncionariosLicencas.findByCorteFolhaEfetiva", query = "SELECT f FROM FuncionariosLicencas f WHERE f.corteFolhaEfetiva = :corteFolhaEfetiva"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtPrevidencia", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtPrevidencia = :dtPrevidencia"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtPublicacaoDiarioOficial", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtPublicacaoDiarioOficial = :dtPublicacaoDiarioOficial"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtInicialOriginal", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtInicialOriginal = :dtInicialOriginal"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtFinalOriginal", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtFinalOriginal = :dtFinalOriginal"),
    @NamedQuery(name = "FuncionariosLicencas.findByPendenciaExameComprobatorio", query = "SELECT f FROM FuncionariosLicencas f WHERE f.pendenciaExameComprobatorio = :pendenciaExameComprobatorio"),
    @NamedQuery(name = "FuncionariosLicencas.findByObservacoes", query = "SELECT f FROM FuncionariosLicencas f WHERE f.observacoes = :observacoes"),
    @NamedQuery(name = "FuncionariosLicencas.findByDtCancelamento", query = "SELECT f FROM FuncionariosLicencas f WHERE f.dtCancelamento = :dtCancelamento"),
    @NamedQuery(name = "FuncionariosLicencas.findByMotivoCancelamento", query = "SELECT f FROM FuncionariosLicencas f WHERE f.motivoCancelamento = :motivoCancelamento")})
public class FuncionariosLicencas implements Serializable {
    ...
    public String toString() {
        return "br.com.folha.model.tabelas5.FuncionariosLicencas[ id=" + id + " ]";
    }
