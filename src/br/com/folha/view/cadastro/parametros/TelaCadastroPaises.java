 ...
 * @author André
 */
public class TelaCadastroPaises extends javax.swing.JFrame {

    
    ControleCadastroPaises controleCadastroPaises;
    BeanCadastroPaises beanCadastroPaises;
    
    /** Creates new form CadastroDeUsuarios */
    public TelaCadastroPaises() {
    ...
    public TelaCadastroPaises(ControleCadastroPaises controleCadastroPaises, BeanCadastroPaises beanCadastroPaises) {
        this.controleCadastroPaises = controleCadastroPaises;  
        this.beanCadastroPaises = beanCadastroPaises;
        ...
        preencherJtable1d(controleCadastroPaises.selecionar());
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(30, 50, 190, 14);
        ...
        jTextField2.setBounds(120, 50, 590, 25);
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        boolean cadastrou = controleCadastroPaises.cadastrar(jTextField2.getText().toUpperCase());
        if(cadastrou){
            limparCampos();
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==1){
            String seqPais  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
            controleCadastroPaises.excluir(seqPais);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1){
            String seqPais  = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();                          
            String nomePais = jTextField2.getText();
            controleCadastroPaises.alterar(seqPais, nomePais);
        }else{JOptionPane.showMessageDialog(null, "Você deve selecionar uma linha na tabela.");}
    ...
    */
    ...
    public void preencherJtable1d(List<BeanCadastroPaises> dados  ){
        ...
        for ( BeanCadastroPaises beanCadastroPaises : dados) {

            Object[] linha = new Object[] { beanCadastroPaises.getSeqPais(), beanCadastroPaises.getNomePais() };
            modelo.addRow(linha);
        }
 }
